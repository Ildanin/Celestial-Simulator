...
def load_example_to_window(win : Window, example_n : int, additional_info : list = []):
    if   example_n == 0:
        ...
        for i in range(n):
            angle = 2 * pi * i / n
            Celestial_Object(win, cos(angle) * r, sin(angle) * r, m, 5, x_velocity = -sin(angle) * v, y_velocity = cos(angle) * v, color = rainbow_color(angle * 180 / pi), feather = False, trace_len = 1000, collision = impacts)
        ...
        Celestial_Object(win, 400, 0, 10,   10, x_velocity = 0 ,y_velocity = 200, color = (0, 0, 255),   feather = True, trace_len = 1000, trace_quality = 30)
        ...
        Celestial_Object(win, 200, 0, 1,    10, x_velocity = 0 ,y_velocity = 40, color = (0, 0, 255), feather = True, trace_len = 1000, trace_quality = 30)
        Celestial_Object(win, 400, 0, 1,    10, x_velocity = 0 ,y_velocity = 40, color = (0, 0, 255), feather = True, trace_len = 1000, trace_quality = 30)
        ...
        Celestial_Object(win, 200, 0, 1,    10, x_velocity = 0 ,y_velocity = 1600, color = (0, 0, 255),   feather = True, trace_len = 1000, trace_quality = 10)
        Celestial_Object(win, 400, 0, 1,    10, x_velocity = 0 ,y_velocity = 3200, color = (0, 0, 255),   feather = True, trace_len = 1000, trace_quality = 10)
        ...
        Celestial_Object(win, 0,   0, 1600, 30, x_velocity = 0 ,y_velocity = -3,   color = (255, 255, 0), feather = False)
        Celestial_Object(win, 200, 0, 1,    10, x_velocity = 0 ,y_velocity = 3200, color = (0, 0, 255),   feather = True, trace_len = 1000, trace_quality = 10)
        Celestial_Object(win, 400, 0, 1,    10, x_velocity = 0 ,y_velocity = 1600, color = (0, 0, 255),   feather = True, trace_len = 1000, trace_quality = 10)
    elif example_n == 8:
        #sample example
        win.force_equation = GMm_d_r2
        win.gravity_constant = 1